...
::: warning
Use .yaml extension with config files.
:::

::: info
When starting Butler it will verify the correctness of the config file.  
There is strict validation of all settings in the config file, including specific checks that (for example) host names adhere to valid formats, that port numbers are within valid ranges, etc.
...
A consequence of this is that all settings are mandatory, even if you don't use them.

The good news is that the default settings in the provided sample config file will work in most cases, so you only need to change a few settings to get started.
:::

Trying to start Butler without some mandatory settings in the config file will result in an error message.

In the example below three mandatory settings are missing in the `restServerEndpointsEnable` section: apiListEnabledEndpoints, base62ToBase16 and base16ToBase62.

```bash
2025-10-12T08:13:41.300Z error: VERIFY CONFIG FILE: Configuration validation failed with the following errors:
2025-10-12T08:13:41.300Z error: ---
2025-10-12T08:13:41.300Z error:   Path: /Butler/restServerEndpointsEnable
2025-10-12T08:13:41.300Z error:   Error: must have required property 'apiListEnabledEndpoints'
2025-10-12T08:13:41.300Z error:   Validation keyword: required
2025-10-12T08:13:41.300Z error:   Details: {
  "missingProperty": "apiListEnabledEndpoints"
}
2025-10-12T08:13:41.300Z error:   Schema path: #/properties/Butler/properties/restServerEndpointsEnable/required
2025-10-12T08:13:41.301Z error: ---
2025-10-12T08:13:41.301Z error:   Path: /Butler/restServerEndpointsEnable
2025-10-12T08:13:41.301Z error:   Error: must have required property 'base62ToBase16'
2025-10-12T08:13:41.301Z error:   Validation keyword: required
2025-10-12T08:13:41.301Z error:   Details: {
  "missingProperty": "base62ToBase16"
}
2025-10-12T08:13:41.301Z error:   Schema path: #/properties/Butler/properties/restServerEndpointsEnable/required
2025-10-12T08:13:41.301Z error: ---
2025-10-12T08:13:41.301Z error:   Path: /Butler/restServerEndpointsEnable
2025-10-12T08:13:41.301Z error:   Error: must have required property 'base16ToBase62'
2025-10-12T08:13:41.301Z error:   Validation keyword: required
2025-10-12T08:13:41.301Z error:   Details: {
  "missingProperty": "base16ToBase62"
}
```
...
Here is the config file template that ships with the distribution zip file:
