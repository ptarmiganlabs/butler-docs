...
For detailed information about the UDP message payload formats, field specifications, and validations, see the [UDP Payload Format Reference](/v16.0/reference/udp-payload-format).
