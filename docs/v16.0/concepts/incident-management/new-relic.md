...
- **[Setup Guide](/v16.0/getting-started/setup/incident-mgmt-tools/new-relic/)** - Step-by-step configuration
- **[Alert Templates](/v16.0/reference/alert-template-fields/)** - Customize event payloads
