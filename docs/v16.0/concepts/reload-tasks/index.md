...
**[Client-managed Qlik Sense](/v16.0/concepts/reload-tasks/client-managed/)** environments provide the most comprehensive alerting capabilities through Butler's integration with the Qlik Sense logging system.

**Available Alert/Data Destinations**:

- **[Email Notifications](/v16.0/concepts/reload-tasks/client-managed/alert-emails/)** - Rich HTML emails with script logs and custom formatting
- **[Slack & Teams](/v16.0/concepts/reload-tasks/client-managed/alerts-slack-teams/)** - Real-time messages to collaboration platforms
- **[Incident Management](/v16.0/concepts/incident-management/)** - Integration with New Relic, Signl4, and other platforms
...
- **[Setup Guide](/v16.0/getting-started/setup/task-alerts/)** - Complete configuration walkthrough
- **[Client-Managed Alerts](/v16.0/concepts/reload-tasks/client-managed/)** - Detailed client-managed capabilities
- **[Template Fields](/v16.0/reference/alert-template-fields/)** - Available template variables
- **[Incident Management](/v16.0/concepts/incident-management/)** - Advanced alerting integrations
