...
A comparison of the different destinations is available in the [setup documentation](/v16.0/getting-started/setup/task-alerts/client-managed/).
...
- **[Alert Emails](/v16.0/concepts/reload-tasks/client-managed/alert-emails/)** - Comprehensive HTML email alerts with script logs and custom formatting

### Messaging Platforms

- **[Slack & Teams Alerts](/v16.0/concepts/reload-tasks/client-managed/alerts-slack-teams/)** - Rich formatted messages to Slack channels and Microsoft Teams

### Incident Management

- **[New Relic](/v16.0/concepts/incident-management/new-relic)** - Send alerts to New Relic for incident tracking and analysis
- **[Signl4](/v16.0/concepts/incident-management/signl4)** - Mobile-first incident management with escalation policies
...
For detailed configuration instructions, see the [setup documentation](/v16.0/getting-started/setup/task-alerts/client-managed/).
