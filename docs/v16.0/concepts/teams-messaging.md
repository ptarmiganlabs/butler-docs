...
The [reference section](/v16.0/reference/alert-template-fields/client-managed/) includes a complete list of available template variables.
...
- **[Task Alerts Setup](/v16.0/getting-started/setup/task-alerts/)** - Configure Butler to send task alerts to Teams
- **[Windows Service Monitor](/v16.0/getting-started/setup/windows-service-monitor/)** - Set up Windows service monitoring with Teams notifications
