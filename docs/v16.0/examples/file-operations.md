...
3. Make sure the [necessary Sense data connections](/v16.0/getting-started/setup/data-connections/) exist.
...
Described [here](/v16.0/getting-started/setup/).
...
Described [here](/v16.0/getting-started/setup/data-connections/).
