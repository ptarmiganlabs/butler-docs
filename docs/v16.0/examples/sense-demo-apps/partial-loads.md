...
The full API documentation is available in the [Reference section](/v16.0/reference/rest-api), here we're interested in the PUT `/v4/app/{appId}/reload` endpoint.
