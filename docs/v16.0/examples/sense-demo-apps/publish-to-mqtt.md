...
Assuming the [.qvs helper subs](/v16.0/reference/sense-helper-subs) are used, only one line of script is needed to publish a MQTT message.
...
- [Messaging from Load Script](/v16.0/examples/messaging-from-load-script) - More examples of Slack and MQTT messaging
- [Butler helper functions](/v16.0/reference/sense-helper-subs) - Complete reference for all load script helper subs
