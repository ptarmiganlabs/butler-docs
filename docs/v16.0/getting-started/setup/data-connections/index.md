...
Assuming Butler's [key-value store is enabled](/v16.0/getting-started/setup/key-value-store/) in the main config file, you can create a dummy key-value pair using a POST command with the following payload.
