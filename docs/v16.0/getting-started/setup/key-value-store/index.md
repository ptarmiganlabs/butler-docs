...
Key-value data is manipulated using Butler's [REST API](/v16.0/reference/rest-api).

The [Reference docs](/v16.0/reference/key-value-store) section has more information about the key-value store.
