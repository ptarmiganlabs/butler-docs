...
- [Configuring Butler's REST API](/v16.0/getting-started/setup/rest-api/) — Overall REST API configuration, including the `restServerConfig` block.
- [Config file reference](/v16.0/reference/config-file) — Full reference for every `restServerConfig` setting.
- [Security Considerations](/v16.0/security) — Security guidance for Butler, including the REST API listener.
