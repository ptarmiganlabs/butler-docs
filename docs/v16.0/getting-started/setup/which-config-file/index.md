...
A description of the config file format is available [here](/v16.0/reference/config-file).
...
Update it as needed (see the [config file reference page](/v16.0/reference/config-file) for details).
