...
2. Edit the Slack section of the config file, i.e. in `Butler.slackNotification.reloadTaskFailure`.
   ...
   The `basicMsgTemplate` property is the message that will be sent via Slack. [Template fields](/v16.0/reference/alert-template-fields/) can be used.
...
The concept is the same for all alert types, see the [email alerts](/v16.0/getting-started/setup/task-alerts/#how-it-works) for details.
