...
Previously, only reload tasks were supported. See the [upgrade notes](/v16.0/getting-started/upgrade#upgrading-to-butler-1500) for configuration changes required when upgrading.
:::
