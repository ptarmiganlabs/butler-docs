...
The same feature is however also available from Butler itself, see [this page](/v16.0/examples/openapi-docs).
:::
...
- [Butler Examples](/v16.0/examples/) - Code examples and use cases
- [Configuration Guide](/v16.0/reference/config-file) - API configuration options
