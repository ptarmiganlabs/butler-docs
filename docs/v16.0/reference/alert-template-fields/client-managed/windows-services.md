...
Please see the [Getting started](/v16.0/getting-started/setup/windows-service-monitor/) sections for more information on how to set up alerts for each destination.
:::
...
- [Email](/v16.0/getting-started/setup/windows-service-monitor/email/)
- [Slack](/v16.0/getting-started/setup/windows-service-monitor/slack/)
- [Teams](/v16.0/getting-started/setup/windows-service-monitor/teams/)
