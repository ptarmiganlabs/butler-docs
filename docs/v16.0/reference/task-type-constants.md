...
See the [InfluxDB reference](/v16.0/reference/influxdb) for complete details on tags and fields for each measurement.

## Related Resources

- [Setting up task alerts](/v16.0/getting-started/setup/task-alerts/) - Configure alerts for all task types
- [InfluxDB reference](/v16.0/reference/influxdb) - Complete InfluxDB measurement documentation
- [Config file reference](/v16.0/reference/config-file) - Configuration options for each task type
