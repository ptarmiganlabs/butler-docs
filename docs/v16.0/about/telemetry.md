...
Instructions are available on the [telemetry setup page](/v16.0/getting-started/setup/telemetry/).
...
The [legal page](/v16.0/legal-stuff#telemetry-data) has more information about this.
