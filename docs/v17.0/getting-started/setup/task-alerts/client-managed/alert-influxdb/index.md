...
A complete definition of all information sent to InfluxDB is available in the [reference section](/v17.0/reference/influxdb).
...
For detailed information about all fields and tags stored in InfluxDB for each task type, see the [InfluxDB reference documentation](/v17.0/reference/influxdb).
