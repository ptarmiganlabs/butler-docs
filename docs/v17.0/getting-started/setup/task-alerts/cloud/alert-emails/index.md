...
See the [Concepts section](/v17.0/concepts/reload-tasks/) for additional details and sample alert emails.
...
See the same section for [client-managed Qlik Sense](/v17.0/getting-started/setup/task-alerts/client-managed/alert-emails/#sending-test-emails-to-verify-correct-settings).  
