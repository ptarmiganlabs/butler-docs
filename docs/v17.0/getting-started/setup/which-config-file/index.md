...
A description of the config file format is available [here](/v17.0/reference/config-file).
...
Update it as needed (see the [config file reference page](/v17.0/reference/config-file) for details).
