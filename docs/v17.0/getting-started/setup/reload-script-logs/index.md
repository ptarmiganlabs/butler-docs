...
This feature relies on the same Qlik Sense log appenders that the [reload alerts](/v17.0/getting-started/setup/task-alerts/) uses. Please see that page for an in-depth discussion on how log appenders work and how to set them up.
