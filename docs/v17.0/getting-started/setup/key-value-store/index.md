...
Key-value data is manipulated using Butler's [REST API](/v17.0/reference/rest-api).

The [Reference docs](/v17.0/reference/key-value-store) section has more information about the key-value store.
