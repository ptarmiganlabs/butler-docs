...
Please see the [Concepts](/v17.0/concepts/) and [Getting started](/v17.0/getting-started/setup/task-alerts/) sections for more information about which alert types support templates.
:::
