...
- [Sense app introspection and metadata](/v17.0/examples/sense-app-introspection) — Examples of using the app dump endpoints, including the new lineage data.
- [Task Management](/v17.0/reference/rest-api/tasks) — Reference page listing the app dump endpoints.
