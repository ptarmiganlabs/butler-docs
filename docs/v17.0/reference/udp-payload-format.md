...
Butler:
  udpServerConfig:
    ...
    # Deduplication settings for scheduler UDP messages (new in 17.0)
    deduplication:
...
For detailed information about queue management, performance tuning, and troubleshooting, see the [UDP Queue](/v17.0/concepts/udp-queue) concepts page.
...
Butler requires Qlik Sense log appenders to be configured to send UDP messages. See the [task alerts setup guide](/v17.0/getting-started/setup/task-alerts/client-managed/) for details on configuring log appenders.
