...
The same feature is however also available from Butler itself, see [this page](/v17.0/examples/openapi-docs).
:::
...
- [Butler Examples](/v17.0/examples/) - Code examples and use cases
- [Configuration Guide](/v17.0/reference/config-file) - API configuration options
