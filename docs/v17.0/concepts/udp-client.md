...
For detailed information about the UDP message payload formats, field specifications, and validations, see the [UDP Payload Format Reference](/v17.0/reference/udp-payload-format).
