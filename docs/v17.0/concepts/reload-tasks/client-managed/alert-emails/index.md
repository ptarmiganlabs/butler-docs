...
Instructions for how to configure this feature is available in the [setup documentation](/v17.0/getting-started/setup/task-alerts/client-managed/alert-emails/#send-alerts-only-for-some-tasks).
...
Instructions for how to configure this feature is available in the [setup documentation](/v17.0/getting-started/setup/task-alerts/client-managed/alert-emails/#send-alerts-to-specific-people-for-some-tasks).
...
- **[Setup Guide](/v17.0/getting-started/setup/task-alerts/client-managed/alert-emails/)** - Configure email alerts step-by-step
- **[Template Fields](/v17.0/reference/alert-template-fields/)** - Complete list of available template variables
- **[Slack & Teams Alerts](/v17.0/concepts/reload-tasks/client-managed/alerts-slack-teams/)** - Alternative messaging platforms
