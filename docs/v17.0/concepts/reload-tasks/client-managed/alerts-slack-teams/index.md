...
For a complete list, see the [template fields reference](/v17.0/reference/alert-template-fields/).
...
The configuration needed for setting this up is described in the [setup documentation](/v17.0/getting-started/setup/task-alerts/).
...
- **[Teams Setup Guide](/v17.0/getting-started/setup/task-alerts/client-managed/alert-teams/)** - Configure Microsoft Teams integration
- **[Slack Setup Guide](/v17.0/getting-started/setup/task-alerts/client-managed/alert-slack/)** - Configure Slack integration
- **[Template Fields](/v17.0/reference/alert-template-fields/)** - Complete template variable reference
- **[Email Alerts](/v17.0/concepts/reload-tasks/client-managed/alert-emails/)** - Alternative email notifications
