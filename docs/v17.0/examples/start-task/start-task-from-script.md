...
- Sense data connections as described in the [Getting started](/v17.0/getting-started/setup/data-connections/) section.
...
Documentation about Butler's key-value store is available [here](/v17.0/concepts/key-value).

An example showing how task chaining with parameters can be done using key-values is found [here](/v17.0/examples/reload-chaining).
