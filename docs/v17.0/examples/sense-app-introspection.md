...
For the full reference, including the JSON structure of the `lineage` object, see [App dump lineage data](/v17.0/reference/rest-api/app-dump-lineage).
...
- [Butler helper functions](/v17.0/reference/sense-helper-subs) - Load script helper functions
