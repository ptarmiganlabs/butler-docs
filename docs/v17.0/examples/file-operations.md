...
3. Make sure the [necessary Sense data connections](/v17.0/getting-started/setup/data-connections/) exist.
...
Described [here](/v17.0/getting-started/setup/).
...
Described [here](/v17.0/getting-started/setup/data-connections/).
